    ...
    <div className="space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="rounded-md border border-[var(--line)] bg-white px-4 py-2 text-sm font-medium hover:bg-[var(--panel)]"
          >
            Edit
          </Link>
      ...
      {person.biography && (
        <section className="rounded-xl border border-[var(--line)] bg-[var(--panel)] p-6">
          <h2 className="font-[family-name:var(--font-display)] text-2xl">Biography</h2>
